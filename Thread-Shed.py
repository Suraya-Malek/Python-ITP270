...
print("Transactions without + sign: " )
...
print("Transact without whitespace: ")
...
print("Thread sold: " + str(thread_sold))
...
print("Printing total sales: " + str(total_sales))
...
print("Total white thread: " + str(color_count('white')))

# :face_with_monocle: HERE IS THE PROBLEM LINE!!! The output gives me 112, wich also affects my last two line's the string formatting numbers, too
